...
AUTHENTICATION_BACKENDS = ['users.backends.EmailBackend','django.contrib.auth.backends.ModelBackend',] # new
...
INSTALLED_APPS = [
    ...
    #"contract_rate.apps.ContractRateConfig",
    "crispy_forms",
    "phone_field",
]
